(() => {
  ...
  const TEXT_PAIRS = [
    ...
    { zh: "投递数据图", en: "Application Activity Chart" },
    { zh: "按天看投递、爬取、已查阅和不合适的变化", en: "See daily changes for applications, crawls, reviewed jobs, and dismissals." },
    { zh: "默认只显示投递，点击指标可切换显示。", en: "Only applications are shown by default. Click a metric to toggle it." },
    { zh: "总时间", en: "All Time" },
    { zh: "7 日", en: "7 Days" },
    { zh: "本月", en: "This Month" },
    { zh: "30 日", en: "30 Days" },
